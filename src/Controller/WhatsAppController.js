...
console.log('cai na tela certa')
})
     
})
.catch(err=>{
    console.log(err, ' caiu aqui na tela error')
})
    

    
} 
// crinaod a lista de contato puxando do firebase
initContacts(){
...
// filtrando todos elementos id do html 
loadElements(){
...
elementsPrototype(){
 ...
 Element.prototype.HsClass = function(name){
...
this.el.inputPhoto.on('change', e=>{
    ...
    // para fazer forEach na coleção  sempre usar [...]
...
/*
this.el.inputText('keypress', function(event) {
    if (event.key === 'Enter') {
